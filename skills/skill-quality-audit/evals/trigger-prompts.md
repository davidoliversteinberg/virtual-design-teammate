...
- `frontend-design`: "Build this Optimizely screen from the supplied Figma frame." | "Make this page feel calmer and more premium." | AMBIG "Does this screen look right?" (winner: `design-review` for critique only; `frontend-design` when the user asks to change, build, polish, or redesign it).
