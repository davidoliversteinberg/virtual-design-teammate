...
Inline spec with states, edge cases at scale, and permission variants. Route copy to `ux-writing`, visible component composition and implementation to `frontend-design`, and WCAG depth to `accessibility`.
