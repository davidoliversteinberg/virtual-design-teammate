...
3. **Component mapping.** Each element -> Axiom component with props/variant, verified through connected Axiom tools or installed packages; intentional deviations are flagged with rationale. Route net-new visible component decisions to `frontend-design`.
...
Inline spec structured per above, ready to paste into the team's ticket or documentation system. Route implementation review and rendered completion to `frontend-design`.
