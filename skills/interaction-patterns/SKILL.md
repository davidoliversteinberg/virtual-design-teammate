...
description: >
  ...
  (route to enterprise-patterns), or for rewriting one known interface string (route to ux-writing).
...
Inline spec: the pattern choice, behavior per state, and edge cases. Copy goes to `ux-writing`; visible motion, component composition, and implementation go to `frontend-design`.
