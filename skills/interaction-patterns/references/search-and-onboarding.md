...
- Contextual education over upfront tours: tooltips or coach marks at the moment of first encounter, one at a time, dismiss-and-never-nag. Define activation with `success-metrics` and use connected analytics when available.
